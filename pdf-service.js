      ...
      "/pdf": {
        get: {
          ...
          parameters: [
            ...
            { name: "marginTop", in: "query", required: false, schema: { type: "string", example: "1in" }, description: "Top margin (overrides uniform margin)" },
            { name: "marginRight", in: "query", required: false, schema: { type: "string", example: "0.5in" }, description: "Right margin (overrides uniform margin)" },
            { name: "marginBottom", in: "query", required: false, schema: { type: "string", example: "1in" }, description: "Bottom margin (overrides uniform margin)" },
            { name: "marginLeft", in: "query", required: false, schema: { type: "string", example: "0.5in" }, description: "Left margin (overrides uniform margin)" },
            { name: "printBackground", in: "query", required: false, schema: { type: "boolean", default: true, example: true }, description: "Whether to print background graphics and colors" },
            { name: "displayHeaderFooter", in: "query", required: false, schema: { type: "boolean", default: false, example: false }, description: "Whether to display header and footer" },
